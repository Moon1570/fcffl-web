...
if($_SESSION["password"]!=$_POST['oldpassword']){
    ...
    $sql = "UPDATE admin SET username='".$_POST['username']."', email='".$_POST['email']."', password='".$_POST['newpass']."', firstname='".$_POST['firstname']."', lastname='".$_POST['lastname']."', address='".$_POST['address']."', city='".$_POST['city']."', country='".$_POST['country']."', postal_code='".$_POST['postal_code']."', about_me='".$_POST['about_me']."' WHERE aid = '".$_SESSION["aid"]."'";
}
